...
public class PekerjaanController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!(userName == null || userName.equals(""))){
            ...
            if (tombol.equals("Lihat") || tombol.equals("Sebelumnya") || tombol.equals("Berikutnya") || tombol.equals("Tampilkan")){
                ...
                if (listPekerjaan != null){
                    for (int i = 0; i < listPekerjaan.length; i++){
                        kontenLihat += "<tr>";
                        if (i == 0){
                            kontenLihat += "<td><input type='radio' checked name='kodePekerjaanDipilih' value='"+listPekerjaan[i][0].toString()+"'></td>";
                        } else {
                            kontenLihat += "<td><input type='radio' name='kodePekerjaanDipilih' value='"+listPekerjaan[i][0].toString()+"'></td>";
                        }
                        kontenLihat += "<td>";
                ...
                kontenLihat += "<tr><td align='center'><input type='submit' name='tombol' value='Tampilkan' style='width: 90px'></td>";
                kontenLihat += "</tr>";
            }
            ...
            konten += "<tr><td colspan='2' align='center'><br></td></tr>";
            konten += kontenLihat;
            konten += "</table>";
            konten += "</form>";
